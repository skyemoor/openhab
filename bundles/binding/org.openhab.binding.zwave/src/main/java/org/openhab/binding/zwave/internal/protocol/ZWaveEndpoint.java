...
public class ZWaveEndpoint {
	 ...
	 */
	public ZWaveEndpoint(ZWaveNode node, int endpointId) {
		this.node = node;
	...
	/**
	 * Returns the Command classes this endpoint implements.
	...
	/**
	 * Returns a commandClass object this endpoint implements.
	 * @param commandClass The command class to get.
	 * @return the command class.
	 * @throws IllegalArgumentException thrown when this endpoint does not support this command class.
	 */
	public ZWaveCommandClass getCommandClass(CommandClass commandClass) throws IllegalArgumentException
	{
		if (!supportedCommandClasses.containsKey(commandClass))
			throw new IllegalArgumentException(String.format("Command class not supported by node %d (endpoint %d)", node.getNodeId(), endpointId));
